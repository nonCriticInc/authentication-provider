...
func main() {
	srv := config.New()
	log.Print(service.NewCertBuilder().GetCerts())
	//cert:=data.Cert{
	//	OrgId:        "01",
	//	PublicKey:    PublicKey,
	//	PrivateKey:   PrivateKey,
	//}
	//service.NewCertBuilder().InitRsaKeyPair().OrgId("02").Persist()
	fmt.Print(service.NewCertBuilder().GetCerts()[1])
...
//sudo docker run --name mongodb --restart=always -d -p 27017:27017 mongo mongod